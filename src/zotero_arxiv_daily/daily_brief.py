...
def generate_daily_brief(
    ...
    user = (
        ...
        "story and the push title is displayed directly above it, so leave its headline "
        "empty and make sure its insight adds new detail (2-3 sentences with the key "
        "mechanism and result) instead of rephrasing the title. "
        "The next one or two items get a 1-2 sentence insight. Any remaining items appear in "
        "a quick-scan list: their headline alone must carry the hook, and their insight should "
